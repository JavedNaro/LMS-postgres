...
module.exports = {
    createStudent:async(req, res ) =>{
        ...
        const createuser = await usercontroller.createStudentHelper({firstName:firstName,lastNmae:lastName,email:email,phoneNUmbers:phoneNUmbers});
        // console.log("pprintiing the returened createUser value:")
        // console.log(create.id);
        const createStudent = await studentservice.createstudent({userId:createuser.id,Department:Student.Department,
